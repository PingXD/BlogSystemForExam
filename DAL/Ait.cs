...
namespace DAL
{
    public class Ait
    {
        ...
        public static int Add(articles saveart)
        {
            ...
            string sql = string.Format("INSERT into articles (article_title,article_content,article_class) VALUES ('{0}','{1}','{2}')", saveart.article_title, saveart.article_content,saveart.article_class);
